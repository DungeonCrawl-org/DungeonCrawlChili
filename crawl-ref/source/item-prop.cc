...
// brand weights for whips and leiomano
static const vector<brand_weight_tuple> WHIP_BRANDS = {
    { SPWPN_NORMAL, 34 },
    { SPWPN_VENOM,         16 },
...
static const weapon_def Weapon_prop[] =
{
    ...
    { WPN_CLUB,              "club",                5,  3, 13,
        ...
        WPNF_WOODEN, DAMV_CRUSHING, 10, 0, 5, CLUB_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_SPIKED_FLAIL,      "old spiked flail",    5,  3, 13,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_WOODEN, DAMV_CRUSHING, 0, 0, 0, {} },
#endif
    { WPN_WHIP,              "whip",                6,  2, 11,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_WOODEN, DAMV_SLASHING, 4, 0, 25, WHIP_BRANDS},
    { WPN_LEIOMANO,          "leiomano",            4,  2, 10,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_WOODEN | WPNF_LIGHTWEIGHT, DAMV_SLASHING, 1, 2, 85, WHIP_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_HAMMER,            "old hammer",          7,  3, 13,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CRUSHING, 0, 0, 0, M_AND_F_BRANDS },
#endif
    { WPN_MACE,              "mace",                8,  3, 14,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CRUSHING, 9, 0, 30, M_AND_F_BRANDS },
    { WPN_FLAIL,             "flail",              10,  0, 14,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CRUSHING, 8, 10, 35, M_AND_F_BRANDS },
    { WPN_MORNINGSTAR,       "morningstar",        13, -2, 15,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CRUSHING | DAM_PIERCE, 7, 20, 60, {
            { SPWPN_PROTECTION,     30 },
            { SPWPN_NORMAL,         15 },
            { SPWPN_HOLY_WRATH,     15 },
            { SPWPN_DRAINING,       10 },
    ...
    { WPN_DEMON_WHIP,        "demon whip",         11,  1, 11,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLASHING, 0, 13, 250, DEMON_BRANDS },
    { WPN_SACRED_SCOURGE,    "sacred scourge",     12,  0, 11,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLASHING, 0, 0, 300, HOLY_BRANDS },
    { WPN_DIRE_FLAIL,        "dire flail",         13, -3, 13,
        SK_MACES_FLAILS, SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CRUSHING | DAM_PIERCE, 2, 20, 50, M_AND_F_BRANDS },
    { WPN_EVENINGSTAR,       "eveningstar",        15, -1, 15,
        SK_MACES_FLAILS, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CRUSHING | DAM_PIERCE, 0, 13, 270, {
            { SPWPN_PROTECTION,     30 },
            { SPWPN_DRAINING,       19 },
            { SPWPN_HOLY_WRATH,     15 },
            { SPWPN_NORMAL,          8 },
    ...
    { WPN_GREAT_MACE,        "great mace",         17, -4, 17,
        SK_MACES_FLAILS, SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CRUSHING, 3, 24, 100, M_AND_F_BRANDS },
    { WPN_GIANT_CLUB,        "giant club",         20, -6, 16,
        SK_MACES_FLAILS, SIZE_LARGE, NUM_SIZE_LEVELS,
        WPNF_WOODEN, DAMV_CRUSHING, 1, 25, 21, CLUB_BRANDS },
    { WPN_GIANT_SPIKED_CLUB, "giant spiked club",  22, -7, 18,
        SK_MACES_FLAILS, SIZE_LARGE, NUM_SIZE_LEVELS,
        WPNF_WOODEN, DAMV_CRUSHING | DAM_PIERCE, 1, 25, 26, CLUB_BRANDS },

    // Short Blades
    { WPN_DAGGER,            "dagger",              4,  6, 10,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_PIERCING, 10, 40, 20, {
            { SPWPN_VENOM,          28 },
            { SPWPN_NORMAL,         20 },
            { SPWPN_SPEED,          10 },
            { SPWPN_DRAINING,        9 },
    ...
    { WPN_QUICK_BLADE,       "quick blade",         4,  6, 12,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_LIGHTWEIGHT, DAMV_PIERCING, 0, 25, 250, {
            { SPWPN_NORMAL,         43 },
            { SPWPN_VENOM,          17 },
            { SPWPN_DRAINING,        9 },
            { SPWPN_PROTECTION,      6 },
    ...
    { WPN_ATHAME,       "athame",         7, 5, 12,
        SK_SHORT_BLADES, SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_PIERCING, 2, 15, 100, {
            { SPWPN_NORMAL,          28 },
            { SPWPN_FLAMING,         10 },
            { SPWPN_FREEZING,        10 },
            { SPWPN_PROTECTION,      10 },
    ...
    { WPN_FALCHION,              "falchion",               8,  2, 13,
        ...
        WPNF_NO_FLAGS, DAMV_SLICING, 7, 0, 30, LBL_BRANDS }, // DAMV_CHOPPING...?
    { WPN_LONG_SWORD,            "long sword",            10,  1, 14,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLICING, 7, 10, 35, LBL_BRANDS },
    { WPN_SCIMITAR,              "scimitar",              12, 0, 14,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLICING, 6, 20, 60, LBL_BRANDS },
    { WPN_DEMON_BLADE,           "demon blade",           13, -1, 13,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLICING, 0, 13, 250, DEMON_BRANDS },
    { WPN_EUDEMON_BLADE,         "eudemon blade",         14, -2, 12,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLICING, 0, 0, 300, HOLY_BRANDS },
    { WPN_DOUBLE_SWORD,          "double sword",          15, -1, 15,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_MEDIUM,
        WPNF_NO_FLAGS, DAMV_SLICING, 0, 13, 270, LBL_BRANDS },
    { WPN_GREAT_SWORD,           "great sword",           17, -3, 17,
        SK_LONG_BLADES,  SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_SLICING, 6, 20, 100, LBL_BRANDS },
    { WPN_TRIPLE_SWORD,          "triple sword",          19, -4, 18,
        SK_LONG_BLADES,  SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_SLICING, 0, 24, 150, LBL_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_BLESSED_FALCHION,      "old falchion",         8,  2, 13,
        SK_LONG_BLADES,  SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_SLICING, 0, 0, 0, {} },
    ...
    { WPN_HAND_AXE,          "hand axe",            7,  3, 13,
        ...
        WPNF_NO_FLAGS, DAMV_CHOPPING, 9, 0, 30, AXE_BRANDS },
    { WPN_WAR_AXE,           "war axe",            11,  0, 15,
        SK_AXES,       SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CHOPPING, 7, 25, 35, AXE_BRANDS },
    { WPN_BROAD_AXE,         "broad axe",          13, -2, 16,
        SK_AXES,       SIZE_LITTLE, SIZE_MEDIUM,
        WPNF_NO_FLAGS, DAMV_CHOPPING, 4, 25, 90, AXE_BRANDS },
    { WPN_BATTLEAXE,         "battleaxe",          15, -4, 17,
        SK_AXES,       SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CHOPPING, 6, 25, 100, AXE_BRANDS },
    { WPN_EXECUTIONERS_AXE,  "executioner's axe",  18, -6, 19,
        SK_AXES,       SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CHOPPING, 0, 25, 150, AXE_BRANDS },

    // Polearms
    { WPN_SPEAR,             "spear",               6,  4, 11,
        SK_POLEARMS,     SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_PIERCING, 8, 0, 30, {
            { SPWPN_NORMAL,     46 },
            { SPWPN_VENOM,      17 },
            { SPWPN_HEAVY,      12 },
            { SPWPN_FLAMING,     7 },
    ...
    { WPN_TRIDENT,           "trident",             9,  1, 13,
        ...
        WPNF_NO_FLAGS, DAMV_PIERCING, 6, 20, 35, POLEARM_BRANDS },
    { WPN_HALBERD,           "halberd",            13, -3, 15,
        SK_POLEARMS,     SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CHOPPING | DAM_PIERCE, 5, 15, 40, POLEARM_BRANDS },
#if TAG_MAJOR_VERSION == 34
    { WPN_SCYTHE,            "old scythe",         14, -4, 20,
        SK_POLEARMS,     SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_SLICING, 0, 0, 0, POLEARM_BRANDS },
#endif
    { WPN_PARTISAN,           "partisan",          14, 1, 17,
        SK_POLEARMS,     SIZE_LITTLE, SIZE_MEDIUM,
        WPNF_NO_FLAGS, DAMV_PIERCING, 3, 25, 70, POLEARM_BRANDS },
    { WPN_DEMON_TRIDENT,     "demon trident",      12,  1, 13,
        SK_POLEARMS,     SIZE_LITTLE, SIZE_MEDIUM,
        WPNF_NO_FLAGS, DAMV_PIERCING, 0, 25, 250, DEMON_BRANDS },
    { WPN_TRISHULA,          "trishula",           13,  0, 13,
        SK_POLEARMS,     SIZE_LITTLE, SIZE_MEDIUM,
        WPNF_NO_FLAGS, DAMV_PIERCING, 0, 0, 300, HOLY_BRANDS },
    { WPN_GLAIVE,            "glaive",             15, -3, 17,
        SK_POLEARMS,     SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CHOPPING, 5, 15, 100, POLEARM_BRANDS },
    { WPN_BARDICHE,          "bardiche",           18, -6, 19,
        SK_POLEARMS,     SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_CHOPPING, 1, 25, 150, POLEARM_BRANDS },

    // Staves
    // WPN_STAFF is for weapon stats for magical staves only.
    { WPN_STAFF,             "staff",               5,  5, 12,
        SK_STAVES,       SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_CRUSHING, 0, 0, 15, {} },
    { WPN_QUARTERSTAFF,      "quarterstaff",        10, 3, 13,
        SK_STAVES,       SIZE_LITTLE, NUM_SIZE_LEVELS,
        WPNF_WOODEN, DAMV_CRUSHING, 8, 50, 50, {
            { SPWPN_NORMAL,     44 },
            { SPWPN_SPECTRAL,   18 },
            { SPWPN_DRAINING,    8 },
            { SPWPN_HEAVY,       8 },
    ...
    { WPN_LAJATANG,          "lajatang",            16,-3, 14,
        SK_STAVES,       SIZE_LITTLE, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_SLICING, 2, 50, 150, {
            { SPWPN_NORMAL,         28 },
            { SPWPN_SPEED,          12 },
            { SPWPN_ELECTROCUTION,  12 },
            { SPWPN_VAMPIRISM,      12 },
    ...
    { WPN_BLOWGUN,           "old blowgun",         0,  2, 10,
        ...
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 0, 0, 0, {}, },
#endif

    { WPN_SLING,             "sling",               7,  0, 14,
        SK_RANGED_WEAPONS,   SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 8, 10, 15, RANGED_BRANDS },
    { WPN_HAND_CANNON,       "hand cannon",      16,  3, 19,
        SK_RANGED_WEAPONS,   SIZE_LITTLE, SIZE_LITTLE,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 0, 24, 270, {
    ...
    { WPN_FUSTIBALUS,        "old fustibalus",     10, -2, 16,
        ...
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 0, 0, 150, RANGED_BRANDS },
#endif

    { WPN_SHORTBOW,          "shortbow",            8,  2, 14,
        SK_RANGED_WEAPONS,   SIZE_LITTLE, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 8, 0, 30, RANGED_BRANDS },
    { WPN_ORCBOW,            "orcbow",             11, -3, 15,
        SK_RANGED_WEAPONS,   SIZE_LITTLE, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 8, 20, 40, RANGED_BRANDS },
    { WPN_ARBALEST,          "arbalest",           16, -2, 19,
        SK_RANGED_WEAPONS,   SIZE_LITTLE, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 5, 20, 75, RANGED_BRANDS },
    { WPN_LONGBOW,           "longbow",            14,  0, 17,
        SK_RANGED_WEAPONS,   SIZE_MEDIUM, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 2, 13, 110, RANGED_BRANDS },
    { WPN_TRIPLE_CROSSBOW,   "triple crossbow",    23, -2, 23,
        SK_RANGED_WEAPONS,   SIZE_SMALL, NUM_SIZE_LEVELS,
        WPNF_NO_FLAGS, DAMV_NON_MELEE, 0, 13, 200, RANGED_BRANDS },
...
{
    if (place == BRANCH_SHOALS && w_type == WPN_LEIOMANO)
        return 3;
...
static map<potion_type, item_rarity_type> _potion_rarity = {
    ...
    { POT_GAIN_DEXTERITY,       RARITY_RARER },
    { POT_GAIN_STRENGTH,        RARITY_RARER },
    { POT_GAIN_INTELLIGENCE,    RARITY_RARER },
    { POT_BENEFICIAL_MUTATION,  RARITY_RARER },
...
/*
* Does the weapon in question have innate behavior flags?
 * @param wpn   The given weapon type.
 * @param flag  The flag in question.
 * @return      True if flag is set.
*/
bool weapon_has_flag(int wpn, wpn_flags flag)
{
    return Weapon_prop[Weapon_index[wpn]].flags & flag;
}
