...
{ // The Vaults (OOD cap: 12)
  // Vaults is essentially split in two: Vaults 1-3, the 'normal' part,
  // and Vaults:4, the final challenge.
  // Trying to keep total around 10,000 on each floor 1-3, roughly.

  // Easy enemies:
  {  1,  3,  400, FALL, MONS_YAKTAUR },
  {  1,  3,  350, FALL, MONS_CENTAUR_WARRIOR },
  {  1,  3,  120, FALL, MONS_HARPY },
  {  1,  3,  100, FALL, MONS_BOGGART },
  {  1,  3,  600, FALL, MONS_LINDWURM },
  {  1,  3,   25, FALL, MONS_CRAWLING_FLESH_CAGE },

  {  1,  3,   75, FLAT, MONS_IRONBOUND_MECHANIST },
  {  1,  3,  230, FALL, MONS_IRONBOUND_MECHANIST },
  {  1,  3,  200, FLAT, MONS_DIRE_ELEPHANT },
  {  1,  3,  200, FALL, MONS_DIRE_ELEPHANT },
  {  1,  3,  400, FLAT, MONS_SLIME_CREATURE },
  {  1,  3,  400, FALL, MONS_SLIME_CREATURE },
  // Harder enemies:
  {  1,  3, 1250, FLAT, MONS_VAULT_SENTINEL },
  {  1,  3,  150, FLAT, MONS_ENTROPY_WEAVER },
  {  1,  3,  100, FLAT, MONS_POLTERGUARDIAN },
  {  1,  3, 1200, FLAT, MONS_IRONBOUND_CONVOKER },
  {  1,  3, 1200, FLAT, MONS_IRONBOUND_PRESERVER },
  {  1,  3,  725, FLAT, MONS_IRONBOUND_FROSTHEART },
  {  1,  3,  525, FLAT, MONS_VAULT_WARDEN },
  {  1,  3,  525, RISE, MONS_VAULT_WARDEN },
  {  1,  3,  500, FLAT, MONS_IRONBOUND_THUNDERHULK },
  {  1,  3,  200, RISE, MONS_IRONBOUND_THUNDERHULK },
  {  1,  3,  325, FLAT, MONS_GREAT_ORB_OF_EYES },
  {  1,  3,  325, RISE, MONS_GREAT_ORB_OF_EYES },
  {  1,  3,   45, FLAT, MONS_GLOWING_ORANGE_BRAIN },
  {  1,  3,   45, RISE, MONS_GLOWING_ORANGE_BRAIN },
  {  1,  3,  150, FLAT, MONS_FORMLESS_JELLYFISH },
  {  1,  3,  100, RISE, MONS_FORMLESS_JELLYFISH },
  {  1,  3,  325, FLAT, MONS_ARCANIST },
  {  1,  3,  325, RISE, MONS_ARCANIST },
  {  1,  3,  500, FLAT, MONS_YAKTAUR_CAPTAIN },
  {  1,  3,  400, RISE, MONS_YAKTAUR_CAPTAIN },
  {  1,  3,  100, FLAT, MONS_ORC_WARLORD },
  {  1,  3,   50, RISE, MONS_ORC_WARLORD },
  // Top-tier threats:
  {  1,  3,  145, RISE, MONS_DEATH_KNIGHT },
  {  1,  3,  350, RISE, MONS_PEACEKEEPER },
  {  1,  3,  225, RISE, MONS_SPHINX_MARAUDER },
  {  2,  3,  115, RISE, MONS_GUARDIAN_SPHINX },

  // Vaults:4 enemies. These weights are very roughly based on
  // the monster frequency as of 0.26.
  // V:4 humans:
  {  4, 12, 1000, FALL, MONS_VAULT_WARDEN },
  {  4, 12,  600, FALL, MONS_IRONBOUND_PRESERVER },
  {  4, 12,  520, FALL, MONS_IRONBOUND_CONVOKER },
  {  4, 12,  520, FALL, MONS_VAULT_SENTINEL },
  {  4, 12,  130, FALL, MONS_VAULT_GUARD },
  {  4, 12,   70, FALL, MONS_DEATH_KNIGHT },
  {  4, 12,   90, FALL, MONS_HELL_KNIGHT },
  // V:4 undead friends:
  {  4, 12,  520, FALL, MONS_PHANTASMAL_WARRIOR },
  {  4, 12,  100, FALL, MONS_FREEZING_WRAITH },
  {  4, 12,  110, FALL, MONS_LICH },
  {  4, 12,   45, FALL, MONS_FLAYED_GHOST },
  // V:4 elves:
  {  4, 12,  300, FALL, MONS_DEEP_ELF_HIGH_PRIEST },
  {  4, 12,  150, FALL, MONS_DEEP_ELF_DEATH_MAGE },
  {  4, 12,  150, FALL, MONS_DEEP_ELF_ANNIHILATOR },
  {  4, 12,  150, FALL, MONS_DEEP_ELF_DEMONOLOGIST },
  {  4, 12,  150, FALL, MONS_DEEP_ELF_SORCERER },
  // V:4 giants
  {  4, 12,  700, FALL, MONS_STONE_GIANT },
  {  4, 12,  640, FALL, MONS_ETTIN },
  {  4, 12,  350, FALL, MONS_FIRE_GIANT },
  {  4, 12,  350, FALL, MONS_FROST_GIANT },
  {  4, 12,  220, FALL, MONS_OGRE_MAGE },
  {  4, 12,  120, FALL, MONS_DEEP_TROLL_EARTH_MAGE },
  // V:4 misc:
  {  4, 12,   45, FALL, MONS_ENTROPY_WEAVER },
  {  4, 12,  800, FALL, MONS_YAKTAUR_CAPTAIN },
  {  4, 12,  750, FALL, MONS_GLOWING_SHAPESHIFTER },
  {  4, 12,  600, FALL, MONS_TENGU_REAVER },
  {  4, 12,  260, FALL, MONS_GUARDIAN_SPHINX },
  {  4, 12,  260, FALL, MONS_WAR_GARGOYLE },
  {  4, 12,  300, FALL, MONS_POLTERGUARDIAN },
  {  4, 12,  135, FALL, MONS_IRONBOUND_MECHANIST },
  // V:4 chaff from earlier floors
  {  4, 12,  350, FALL, MONS_CRAWLING_FLESH_CAGE },
  {  4,  4,  650, FLAT, MONS_ORC_KNIGHT },
  {  4,  4,  180, FLAT, MONS_FORMLESS_JELLYFISH },
  {  4,  4,   60, FLAT, MONS_DANCING_WEAPON },
  {  4,  4,   60, FLAT, MONS_GREAT_ORB_OF_EYES },

  // Out-of-depth enemies.
  // These total 860 weight, to avoid being too common
  // relative to the 'normal' enemies.
  {  4, 12,  190, RISE, MONS_TITAN },
  {  4, 12,  155, RISE, MONS_SHADOW_DRAGON },
  {  4, 12,  150, RISE, MONS_UNDYING_ARMOURY },
  {  4, 12,  100, RISE, MONS_STORM_DRAGON },
  {  4, 12,   70, RISE, MONS_GOLDEN_DRAGON },
  {  4, 12,   50, RISE, MONS_QUICKSILVER_DRAGON },
  {  4, 12,   45, RISE, MONS_IRON_DRAGON },
  {  4, 12,   45, RISE, MONS_ANCIENT_LICH },
  {  4, 12,   45, RISE, MONS_DREAD_LICH },
},
...
{ // Sewer
  ...
  {  1,  1,  500, FLAT, MONS_ADDER },
  {  1,  1,  500, FLAT, MONS_RIBBON_WORM },
  {  1,  1,  500, FLAT, MONS_ENDOPLASM },
  {  1,  1,  750, FLAT, MONS_CLOCKROACH },
  {  1,  1,  750, FLAT, MONS_SEWER_RAT },
  {  1,  2,  500, FLAT, MONS_KOBOLD_BRIGAND },
  {  1,  1, 1000, FLAT, MONS_DRAUGR },
  {  1,  2, 1000, FLAT, MONS_JELLY },
  {  1,  3,  125, FLAT, MONS_CROCODILE },
  {  1,  3,  125, FLAT, MONS_BRAIN_WORM },
  {  1,  3,  125, FLAT, MONS_BULLFROG },
  {  2,  3,  125, FLAT, MONS_ICE_BEAST },
  {  2,  3,  125, FLAT, MONS_SKY_BEAST },
  {  2,  3,  200, FLAT, MONS_SHADOWGHAST },
  {  2,  3,  200, FLAT, MONS_WIGHT },
  {  2,  3,   75, FLAT, MONS_BOG_BODY },
  {  2,  3,   55, FLAT, MONS_WATER_MOCCASIN },
  {  3,  3,  100, FLAT, MONS_KOMODO_DRAGON },
  { 0,0,0,FLAT,MONS_0 }
},
